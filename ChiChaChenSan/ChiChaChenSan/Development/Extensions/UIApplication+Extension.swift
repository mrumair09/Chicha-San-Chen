...
extension UIApplication {
    ...
    class func topNavigation(_ viewController: UIViewController? = UIApplication.shared.windows.first?.rootViewController) -> BaseNavigationController? {
        ...
        if let tab = viewController as? UITabBarController {
            if let selected = tab.selectedViewController {
                return selected.navigationController as? BaseNavigationController
            }
        }
        ...
        return viewController?.navigationController as? BaseNavigationController
    }
